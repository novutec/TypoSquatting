 ...
 * @license    http://www.apache.org/licenses/LICENSE-2.0
 */
class Mapping_Es extends AbstractMapping
{
    ...
    protected $map = array('q' => array(1, 2, 'w', 'a'), 'w' => array(2, 3, 'e', 's', 'a', 'q'), 
            ...
            'o' => array(9, 0, 'p', 'l', 'k', 'i'), 'p' => array(0, 'l', 'o', 'ñ'), 
            ...
            'l' => array('o', 'p', 'k', 'ñ'), 'ñ' => array('p', 'l'), 'z' => array('a', 's', 'x'), 
            ...
            '8' => array(7, 9, 'i', 'u'), '9' => array(8, 0, 'o', 'i'), '0' => array(9, 'p', 'o'));
    ...
    protected $double = array('q' => array('w'), 'w' => array('q', 'e'), 'e' => array('w', 'r'), 
            ...
            'k' => array('j', 'l'), 'l' => array('k', 'ñ'), 'ñ' => array('l'), 'z' => array('x'), 
            'x' => array('z', 'c'), 'c' => array('x', 'v'), 'v' => array('c', 'b'), 
            'b' => array('v', 'n'), 'n' => array('b', 'm'), 'm' => array('n'), '1' => array(2), 
     ...
     * @access protected
     */
    protected $similar = array('ç' => array('c'), 'c' => array('ç'), 'ñ' => array('n'), 
            'n' => array('ñ'));
}